...
class SimpleModelSelector:
    ...
    def __init__(self):
        ...
        self.llm_models = {"openai":"GPT-4o-mini", "ollama":"llama3.2:1b"}
    ...
    def select_modes(self):
        ...
        embedding = st.sidebar.radio(
            ...
            format_func=lambda x: self.embedding_models[x]
        )
...
class SimpleFileProcessor:
    ...
    def read_py(self, py_file):
        """Read .py file and return as plain text"""
        return py_file.read().decode("utf-8")
    ...
    def setup_embedding_function(self):
        ...
        try:
            if self.embedding_model == "openai":
                ...
                # self.embedding_fn = embedding_functions.SentenceTransformerEmbedding(
    ...
    def generate_response(self,query,context):
        ...
        try:
            ...
            response = self.llm.chat.completions.create(
                model="gpt-4o-mini" if self.llm_model == "openai" else "llama3.2:1b",
                messages=[
...
def main():
    ...
    model_selector = SimpleModelSelector()
    llm_model, embedding_model = model_selector.select_modes()
    ...
    # File upload
    file = st.file_uploader("Upload your file here", type=["pdf","py","txt"])

    if file and file.name not in st.session_state.processed_files:
        # Process the file
        ...
        with st.spinner("Processing your file...."):
            try:
                if file.name.endswith(".pdf"):
                    ...
                    text = processor.read_py(file)
                else:
                    st.warning("Unsupported file type.")
                    return

                # Criação de chunks e inserção no banco
