...
def chat(
    user_input: str, messages: List[Dict[str,str]], client: OpenAI, model_name: str)-> str:
    ...
    try:
        ...
        # Append assistant's response to tthe conversation
...
def main():
    ...
    model_name = "llama3.2:1b" if use_ollama else "gpt-4o-mini"

    # Initialize or load conversation 
    messages = create_initial_messages()

    print(f"\nUsing {'Ollama' if use_ollama else 'OpenAI'} model. Type the command")
